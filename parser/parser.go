...
func (p *Parser) parseCallExpression(leftExp ast.Expression) ast.Expression {
...
func (p *Parser) parseArray() ast.Expression {
	arrayExp := &ast.ArrayLiteral{Token: p.curToken}
	p.nextToken()
	arrayExp.Elements = p.parseExpressionList(token.RBRACKET)
	return arrayExp
}
...
func (p *Parser) parseIndexExpression(leftExp ast.Expression) ast.Expression {
	indexExp := &ast.IndexExpression{Token: p.curToken, Left: leftExp}
	p.nextToken()
